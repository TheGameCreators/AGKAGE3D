...
Function LAG_ListIconGadget(id, x, y, w, h)
	...
	/* mode = typ for the list :

	mode = 0 -> default, a list with icon + title
	mode = 1 -> little icon + title
	mode = 2 -> square icon+ title
	...
	*/
    ...
    LAG_D_Gadget[i].Typ = LAG_C_TYPLISTICON // the typ of gadget
