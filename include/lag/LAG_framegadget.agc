...
/*
#Constant LAG_C_Frame_Default = 0 //: Cadre enfoncé 
#Constant LAG_C_Frame_Single = 1 //: Cadre enfoncé 
#Constant LAG_C_Frame_Double = 2 // : Cadre doublement enfoncé 
#Constant LAG_C_Frame_Flat = 3   // : Cadre simple 
*/

Function LAG_FrameGadget(id,x,y,w,h,txt$,option$)
    ...
    */
    ...
    SetSpriteColor(SP,30,30,30,alpha)
