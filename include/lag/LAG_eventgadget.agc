						...
						Select LAG_D_Gadget[i].Typ
							...
							case LAG_C_TYPLISTICON, LAG_C_TYPEDITOR
								...
								Select OtherSp // c'est le bouton slider haut ou bas ?
									...
									case 1	//slider top							
										LAG_d_Gadget[i].CurY = LAG_d_Gadget[i].CurY - LAG_d_Gadget[i].CurSpeedY
										inc LAG_d_Gadget[i].CurSpeedY , 0.1 //- LAG_C_SPEEDLISTICONY
									endcase
									
									case 2	//slider botom									
										LAG_d_Gadget[i].CurY = LAG_d_Gadget[i].CurY + LAG_d_Gadget[i].CurSpeedY 
										//+ LAG_C_SPEEDLISTICONY
										inc LAG_d_Gadget[i].CurSpeedY , 0.1
									endcase
										...
										For g = 0 to LAG_D_GadgetItem.length
											if LAG_D_GadgetItem[g].ParentID = i
												...
												For kk=0 to LAG_D_GadgetItem[g].spr.length
													...
													SetSpritePosition(n1,GetSpriteX(n1),ny+h/4)
												next
