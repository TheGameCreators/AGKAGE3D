...
mediump vec3 grassColor = vec3(1.0, 0.0, 0.0); // vec3(0.89, 1.08, 0.77);
mediump vec3 snowColor = vec3(0.0, 1.0, 0.0); // vec3(1.5, 1.5, 1.5);
mediump vec3 rockColor = vec3(0.0, 0.0, 1.0); // vec3(0.75, 0.75, 0.75);
mediump vec4 sandColor = vec4(0.0, 0.0, 0.0, 1.0); // vec3(0.75, 0.75, 0.75);
mediump float snowHeightStart = 15.0; // 35 height that grass begins to turn to snow
mediump float snowHeightEnd = 20.0; // 25 height that it becomes completely snow
mediump float rockStart = 0.8; // 0.8 normals with Y greater than this will be 100% grass
mediump float rockEnd = 0.4; // 0.4 normals with Y less than this will be 100% rock
...
mediump float snowTransition = 0.1; // 0.1 // 1.0 / (35.0 - 25.0)
mediump float rockTransition = 2.5; // 2.5 // 1.0 / (0.8 - 0.4)
